...
# sub-metering - use pmax to create a vector = max(sub1, sub2,sub3)
# with that we create a blank plot to dd separate lines
# used lwd for the first line - otherwise looked too weak
